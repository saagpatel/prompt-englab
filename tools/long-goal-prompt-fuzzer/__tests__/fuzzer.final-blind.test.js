...
describe("Long-Goal Prompt Fuzzer second holdout regression", () => {
  it("matches the explicit independent contract after semantic recognizer hardening", () => {
    const blindDirectory = path.resolve(__dirname, "../fixtures/final-blind");
