...
describe("Long-Goal Prompt Fuzzer sealed blind fixture", () => {
  it("matches the independently authored oracle on the sealed evaluator", () => {
    const blindDirectory = path.resolve(__dirname, "../fixtures/sealed-blind");
